...
exports.handler = async (event) => {
  ...
  try {
    ...
    await sql`CREATE TABLE IF NOT EXISTS juniors (
      id TEXT PRIMARY KEY,
      name TEXT NOT NULL,
      title TEXT,
    ...
    await sql`ALTER TABLE juniors ADD COLUMN IF NOT EXISTS inactive BOOLEAN DEFAULT FALSE`;

    await sql`CREATE TABLE IF NOT EXISTS adults (
      id TEXT PRIMARY KEY,
      name TEXT NOT NULL,
      title TEXT DEFAULT '',
      phone TEXT DEFAULT '',
    ...
    await sql`CREATE TABLE IF NOT EXISTS active_slots (
      id TEXT PRIMARY KEY,
      name TEXT NOT NULL,
      shift TEXT NOT NULL,
    ...
    await sql`CREATE TABLE IF NOT EXISTS committee_requests (
